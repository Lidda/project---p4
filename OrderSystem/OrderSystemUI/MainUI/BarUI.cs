...
namespace OrderSystemUI.MainUI
{
    public partial class BarUI : Form
    {
        ...
        public void Order1(List<Order> orders)
        {
            ...
            orders = orderLogic.GetOrdersBar(1);
        ...
        {
            orders = orderLogic.GetOrdersBar(2);
        ...
        {
            orders = orderLogic.GetOrdersBar(3);
        ...
        {
            orders = orderLogic.GetOrdersBar(4);
        ...
        {
            orders = orderLogic.GetOrdersBar(5);
        ...
        {
            orders = orderLogic.GetOrdersBar(6);
        ...
        {
            orders = orderLogic.GetOrdersBar(7);
        ...
        {
            orders = orderLogic.GetOrdersBar(8);
        ...
        {
            orders = orderLogic.GetOrdersBar(9);
        ...
        {
            orders = orderLogic.GetOrdersBar(10);
